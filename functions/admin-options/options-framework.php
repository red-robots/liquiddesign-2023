...
define('OPTIONS_FRAMEWORK_URL', get_template_directory_uri().'/functions/admin-options/');
...
function optionsframework_load_styles() {
	wp_enqueue_style('admin-style', OPTIONS_FRAMEWORK_URL.'css/admin-style.css?v=20120423234843');
	wp_enqueue_style('color-picker', OPTIONS_FRAMEWORK_URL.'css/colorpicker.css?v=20120423234845');
}	
...
function optionsframework_load_scripts() {
	...
	wp_enqueue_script('color-picker', OPTIONS_FRAMEWORK_URL.'js/colorpicker.js?v=20120423234850', array('jquery'));
	wp_enqueue_script('options-custom', OPTIONS_FRAMEWORK_URL.'js/options-custom.js?v=20120423234848', array('jquery'));
}
